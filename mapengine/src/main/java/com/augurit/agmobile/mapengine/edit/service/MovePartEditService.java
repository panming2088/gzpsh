...
public class MovePartEditService implements IMovePartEditService{

    @Override
    public void saveAfterMovePart(ArcGISFeatureLayer featureLayer,
                                  Object featureId,
                                  List<Point> points,
                                  EditMode mode,
                                  SpatialReference sp,
                                  PartMoveCallback callback){
        Graphic g;
    ...
    public CallbackListener<FeatureEditResult[][]> callbackListener(final PartMoveCallback callback){
    ...
    public interface PartMoveCallback{
