...
public class NewGetPhotosResult {
    ...
    private List<NetPhoto.PhotoInfo> result;
    ...
    public List<NetPhoto.PhotoInfo> getResult() {
        return result;
    }

    public void setResult(List<NetPhoto.PhotoInfo> result) {
        this.result = result;
    }
