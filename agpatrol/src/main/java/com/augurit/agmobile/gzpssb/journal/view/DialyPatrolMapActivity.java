...
public class DialyPatrolMapActivity extends BaseActivity implements IDrawerController {
    protected ProgressLinearLayout progress_linearlayout;
    protected DrawerLayout drawer_layout;

    private DialyPatrolMapFragment mQueryAddressMapFragment;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mQueryAddressMapFragment = new DialyPatrolMapFragment();
