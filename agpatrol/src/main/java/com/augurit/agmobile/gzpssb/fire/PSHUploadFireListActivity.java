...
public class PSHUploadFireListActivity extends BaseActivity {

    private TextView all_count, install_count, no_install_count;
    private DrawerLayout drawer_layout;
    private PSHFireListFragment fireListFragment;
    protected ProgressLinearLayout progress_linearlayout;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_psh_fire_uploadlist);
        initView();
        EventBus.getDefault().register(this);
    }

    private void initView() {
        ((TextView) findViewById(R.id.tv_title)).setText("地上式消防栓上报");
...
//        new FireListFilterConditionView(this, "地上式消防栓列表筛选", FacilityFilterCondition.NEW_ADDED_LIST, );
        new FireListFilterConditionView(llUploadFilterCondition, 0,this);
...
//                GravityCompat.END);
        ...
        fireListFragment = new PSHFireListFragment();
    ...
    @Subscribe
    public void onPSHEventConditionChanged(UploadFireFilterConditionEvent fireFilterConditionEvent) {
