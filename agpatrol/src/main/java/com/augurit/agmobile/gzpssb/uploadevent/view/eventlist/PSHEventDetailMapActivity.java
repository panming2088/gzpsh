...
public class PSHEventDetailMapActivity extends BaseActivity implements IDrawerController {

    protected ViewGroup progress_linearlayout;
    protected DrawerLayout drawer_layout;
    private PSHEventDetailMapFragment eventDetailMapFragment;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        eventDetailMapFragment =  PSHEventDetailMapFragment.getInstance(layerUrl, layerName, usid, x, y);
