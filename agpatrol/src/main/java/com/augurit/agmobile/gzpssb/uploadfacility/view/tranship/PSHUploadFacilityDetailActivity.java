...
public class PSHUploadFacilityDetailActivity extends BaseActivity implements IDrawerController {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PSHUploadFacilityDetailMapFragment uploadDistributeMapFragment = PSHUploadFacilityDetailMapFragment.getInstance(bundle);
