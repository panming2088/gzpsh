 ...
 * @modifyMemo 修改备注：
 */
public class PSHUploadFacilityMapFragment extends Fragment implements View.OnClickListener {
...
//
    ...
    public static PSHUploadFacilityMapFragment getInstance(Bundle data) {
        PSHUploadFacilityMapFragment addComponentFragment2 = new PSHUploadFacilityMapFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_psh_uploadmap, null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView) mView.findViewById(R.id.tv_title)).setText("接驳井上报");
        ...
        mView.findViewById(R.id.ll_search).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(mContext, PSHUploadListActivity.class);
        ...
        */
        ...
        uploadLayerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (layerPresenter != null) {
                    layerPresenter.changeLayerVisibility(PatrolLayerPresenter.UPLOAD_WELL_LAYER_NAME, ifWellVisible);
                }
            }
        });
        //注册当图层可见度发生改变时的回调
        if (layerPresenter != null) {
            layerPresenter.registerLayerVisibilityChangedListener(new PatrolLayerPresenter.OnLayerVisibilityChangedListener() {
                ...
                public void changed(boolean visible, LayerInfo layerInfo) {
                    if (!visible && layerInfo.getLayerName().equals(PatrolLayerPresenter.UPLOAD_WELL_LAYER_NAME)) {
                        //不可见
                        //  myUploadIv.setImageResource(R.drawable.ic_upload_data_normal2);
                        uploadIv.setChecked(false);
                        tv_upload_layer.setTextColor(ResourcesCompat.getColor(getResources(), R.color.invisible_state_text_color, null));
                        ifWellVisible = false;
                    } else if (visible && layerInfo.getLayerName().equals(PatrolLayerPresenter.UPLOAD_WELL_LAYER_NAME)) {
                        //可见
