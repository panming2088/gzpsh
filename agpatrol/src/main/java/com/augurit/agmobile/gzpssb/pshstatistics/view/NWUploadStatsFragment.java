...
public class NWUploadStatsFragment extends Fragment {
    ...
    private String[] lead_yAxle = {"白云", "黄埔", "花都", "番禺", "南沙", "从化", "增城", "林场"};
    private String[] patrol_yAxle = {"白云", "黄埔", "花都", "番禺", "南沙", "从化", "增城", "林场", "总计"};
    private List<String> patrol_type = Arrays.asList("井", "设施点", "全部");
    ...
    private String currentType = "井";
    private String currentTodayType = "井";
        ...
        for (int i = 0; i < patrol_yAxle.length; i++) {
            ...
            if (ListUtil.isEmpty(toDay)) {
                ...
                for (NWUploadYTStats.ToDayBean childOrg : toDay) {
                    if (childOrg.getName().contains(orgName) || (orgName.equals("林场") && childOrg.getName().contains("林业"))) {
