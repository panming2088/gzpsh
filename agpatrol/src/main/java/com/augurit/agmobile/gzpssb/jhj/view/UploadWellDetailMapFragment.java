...
import com.augurit.agmobile.gzpssb.jhj.view.reeditfacility.ReEditModifiedWellActivity;
 ...
 * @modifyMemo 修改备注：
 */
public class UploadWellDetailMapFragment extends Fragment implements View.OnClickListener {
    ...
    public static UploadWellDetailMapFragment getInstance(Bundle data) {
        UploadWellDetailMapFragment addComponentFragment2 = new UploadWellDetailMapFragment();
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        if (mCurrentModifiedFacility != null) {
                            Intent intent = new Intent(mContext, ReEditModifiedWellActivity.class);
...
//                }
    ...
    public void onResume() {
        ...
        if (firstModifiedFacility != null) {
            ...
            progressDialog.show();
            WellCorrectFacilityService correctFacilityService = new WellCorrectFacilityService(mContext);
...
//                    })
            ...
            WellFacilityService uploadFacilityService = new WellFacilityService(mContext);
...
//            }
            ...
            //component_detail_container.removeAllViews();
            MyModifiedWellTableViewManager modifiedIdentificationTableViewManager = new MyModifiedWellTableViewManager(mContext,
...
//        }
        ...
        if (component_detail_container.getChildCount() == 0) {
            ...
            drawGeometry(geometry, mGLayer, true, true);
            UploadWellTableViewManager modifiedIdentificationTableViewManager = null;
            if (completeTableInfo != null) {
                modifiedIdentificationTableViewManager = new UploadWellTableViewManager(mContext,
