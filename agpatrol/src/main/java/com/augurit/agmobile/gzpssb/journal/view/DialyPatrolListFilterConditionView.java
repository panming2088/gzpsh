...
public class DialyPatrolListFilterConditionView {
     ...
     * @param viewGroup
     */
    public DialyPatrolListFilterConditionView(Context context, String filterTitle, String filterListType , ViewGroup viewGroup) {
    ...
    private View initView(String filterTitle) {
        final View root = View.inflate(mContext, R.layout.view_upload_dialy_filter, null);
...
//                }
        ...
        autoPshName = (EditText) root.findViewById(R.id.auto_psh_name);
        setMaxLength(autoPshName,10);
...
//                        display(btn, year, monthOfYear, dayOfMonth);
    ...
    private void initEndDate() {
        ...
        endDate = cal.getTimeInMillis();
        btnEndDate.setText(TimeUtil.getStringTimeYMD(new Date(TempEndDate)));
    }
    ...
    private void initStartDate() {
        ...
        startDate = cal.getTimeInMillis();
        btnStartDate.setText(TimeUtil.getStringTimeYMD(new Date(startDate)));
    }
