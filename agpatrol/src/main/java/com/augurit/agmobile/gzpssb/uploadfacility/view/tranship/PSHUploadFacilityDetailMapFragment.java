...
import com.augurit.agmobile.gzpssb.uploadfacility.service.PSHWellDetailLayerService;
import com.augurit.agmobile.gzpssb.uploadfacility.service.PSHDeleteFacilityService;
 ...
 * @modifyMemo 修改备注：
 */
public class PSHUploadFacilityDetailMapFragment extends Fragment implements View.OnClickListener {
    ...
    private PSHDeleteFacilityService deleteFacilityService;
    ...
    public static PSHUploadFacilityDetailMapFragment getInstance(Bundle data) {
        PSHUploadFacilityDetailMapFragment addComponentFragment2 = new PSHUploadFacilityDetailMapFragment();
...
//                                }
        ...
        uploadLayerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (layerPresenter != null) {
                    layerPresenter.changeLayerVisibility(PatrolLayerPresenter.WELL_LAYER, ifUploadLayerVisible);
                }
            }
        });
        ...
        if (layerPresenter != null) {
            layerPresenter.registerLayerVisibilityChangedListener(new PatrolLayerPresenter.OnLayerVisibilityChangedListener() {
                ...
                public void changed(boolean visible, LayerInfo layerInfo) {
                    if (!visible && layerInfo.getLayerName().contains(PatrolLayerPresenter.WELL_LAYER)) {
                        //不可见
                        //  myUploadIv.setImageResource(R.drawable.ic_upload_data_normal2);
                        uploadIv.setChecked(false);
                        tv_upload_layer.setTextColor(ResourcesCompat.getColor(getResources(),R.color.invisible_state_text_color,null));
                        ifUploadLayerVisible = false;
                    } else if (visible && layerInfo.getLayerName().contains(PatrolLayerPresenter.WELL_LAYER)) {
                        //可见
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        if (mCurrentModifiedFacility != null) {
                            ...
                            Intent intent = new Intent(mContext, PSHReEditUploadFacilityActivity.class);
    ...
    private void initDeleteFacilityService() {
        if (deleteFacilityService == null) {
            deleteFacilityService = new PSHDeleteFacilityService(mContext);
        }
    }
...
//                }
    ...
    public void loadMap() {
        ...
        layerPresenter = new PSHWelllayerPresenter(layerView, new PSHWellDetailLayerService(mContext.getApplicationContext()));
