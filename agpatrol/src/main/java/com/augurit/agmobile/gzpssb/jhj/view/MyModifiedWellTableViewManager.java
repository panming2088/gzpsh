...
public class MyModifiedWellTableViewManager {
    ...
    public MyModifiedWellTableViewManager(
            Context context,
...
//            yinjingAttributes.setAttributeFour(modifiedIdentification.getAttrFour());
            ...
            YinjingAttributeViewUtilNew.addReadOnlyAttributes(mContext, originAttrs, yinjingAttributes, ll_container,null,point,modifiedFacility);
...
//        }
    ...
    private void initView() {
        ...
        root = LayoutInflater.from(mContext).inflate(R.layout.view_mymodified_well_table_view, null);
