    ...
    private void upload() {
        ...
        countDownTimer = new CountDownTimer(CorrectFacilityService.TIMEOUT * 1000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (time % 20 == 0) {
                    ToastUtil.longToast(CorrectOrConfirimWellFacilityActivity.this, "网络忙，请稍等");
                }
            }
                ...
                .subscribe(new Subscriber<ResponseBody>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        CrashReport.postCatchedException(new Exception("核准上报失败，上报用户是：" +
                                BaseInfoManager.getUserName(CorrectOrConfirimWellFacilityActivity.this) + "原因是：" + e.getLocalizedMessage()));
                        showToast("提交失败");
                        //ToastUtil.shortToast(CorrectOrConfirimWellFacilityActivity.this, "提交失败");
                    }
...
//                            showToast("提交成功");
                            // ToastUtil.shortToast(CorrectOrConfirimWellFacilityActivity.this, "提交成功");
...
//                            uploadJournal(modifiedFacility);
                            ...
                            CrashReport.postCatchedException(new Exception("核准上报失败，上报用户是：" +
                                    BaseInfoManager.getUserName(CorrectOrConfirimWellFacilityActivity.this) + "原因是：" + responseBody.getMessage()));
                            showToast("保存失败，原因是：" + responseBody.getMessage());
                            //ToastUtil.shortToast(CorrectOrConfirimWellFacilityActivity.this, "保存失败，原因是：" + responseBody.getMessage());
                        }
                    }
                });
    }
                ...
                .subscribe(new Subscriber<ResponseBody>() {
                    ...
                    public void onError(Throwable e) {
                        CrashReport.postCatchedException(new Exception("巡检上报失败，上报用户是：" +
                                BaseInfoManager.getUserName(CorrectOrConfirimWellFacilityActivity.this) + "原因是：" + e.getLocalizedMessage()));
                        ToastUtil.shortToast(CorrectOrConfirimWellFacilityActivity.this, "巡检提交失败");
                        //ToastUtil.shortToast(CorrectOrConfirimWellFacilityActivity.this, "提交失败");
                    }
                    ...
                    public void onNext(ResponseBody responseBody) {
                        if (responseBody.getCode() == 200) {
                            ...
                            CrashReport.postCatchedException(new Exception("核准上报失败，上报用户是：" +
                                    BaseInfoManager.getUserName(CorrectOrConfirimWellFacilityActivity.this) + "原因是：" + responseBody.getMessage()));
                            ToastUtil.shortToast(CorrectOrConfirimWellFacilityActivity.this, "日常巡检保存失败，原因是：" + responseBody.getMessage());
                            //ToastUtil.shortToast(CorrectOrConfirimWellFacilityActivity.this, "保存失败，原因是：" + responseBody.getMessage());
                        }
                    }
                });
