...
public class DialyPatrolListActivity extends AppCompatActivity {

    private TextView all_count, install_count, no_install_count;
    private DrawerLayout drawer_layout;
    private DialyPatrolListFragment addComponentFragment;
...
//        initView();
        ...
        addComponentFragment = new DialyPatrolListFragment();
    ...
    private void initView() {
        ((TextView) findViewById(R.id.tv_title)).setText("我的日常巡检");
        ...
        new DialyPatrolListFilterConditionView(this, "日志列表筛选", FacilityFilterCondition.MODIFIED_LIST, llModifiedFilterCondition);
