        ...
        uploadEventService.getDetails(mEventListItem.getId(), state)
                ...
                .subscribe(new Subscriber<PSHEventDetail>() {
                    ...
                    public void onError(Throwable e) {
                        DialogUtil.MessageBoxCannotCancel(PSHEventDetailActivity.this, null, "请求数据出错！", new DialogInterface.OnClickListener() {
                            @Override
                ...
                AESEncodeSJID(new Callback2<String>() {
                    ...
                    public void onSuccess(String s) {
                        try {
                            ...
                            ToastUtil.shortToast(PSHEventDetailActivity.this, "请确认手机是否已安装微信");
                        }
                    }

                    @Override
                    public void onFail(Exception error) {
                        ToastUtil.shortToast(PSHEventDetailActivity.this, "无法连接网络，请检查网络设置");
                    }
                });
            }
        });
        ...
        ll_addr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (StringUtil.isEmpty(x)
                    ...
                    ToastUtil.shortToast(PSHEventDetailActivity.this, "地址信息缺失");
                    return;
                }
                ...
                .subscribe(new Subscriber<Result<String>>() {
                    ...
                    public void onNext(Result<String> stringResult) {
                        ...
                        if (stringResult != null && stringResult.isSuccess()) {
                            ToastUtil.longToast(PSHEventDetailActivity.this, "删除成功!");
                            ...
                            if (!TextUtils.isEmpty(stringResult.getMessage())) {
                                ...
                                ToastUtil.longToast(PSHEventDetailActivity.this, "无法删除!");
                            }
                        }
                    }
                });
    ...
    private void AESEncodeSJID(final Callback2<String> callback) {
        ...
        gzpsService.AESEncode("" + mEventDetail.getId())
                ...
                .subscribe(new Subscriber<Result2<String>>() {
                    ...
                    @Override
                    public void onError(Throwable e) {
                        ToastUtil.shortToast(PSHEventDetailActivity.this, "无法获取处理情况！");
                    }
    ...
    private void signEvent() {
        mEventService.signEvent(String.valueOf(mEventListItem.getId()))
                ...
                .subscribe(new Subscriber<Boolean>() {
                    ...
                    public void onError(Throwable throwable) {
                        pd.dismiss();
                        ToastUtil.shortToast(PSHEventDetailActivity.this, "操作失败，请重试！");
                    }
                    ...
                    public void onNext(Boolean s) {
                        if (s) {
                            pd.dismiss();
                            ToastUtil.shortToast(PSHEventDetailActivity.this, "操作成功");
                            setResult(123);
                            finish();
                        } else {
                            pd.dismiss();
