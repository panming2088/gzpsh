...
public class EventListFilterConditionView {
     ...
     * @param viewGroup
     */
    public EventListFilterConditionView(Context context, String filterTitle, String filterListType , ViewGroup viewGroup) {
    ...
    private View initView(String filterTitle) {
        final View root = View.inflate(mContext, R.layout.view_upload_event_filter, null);
