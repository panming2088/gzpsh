...
import com.augurit.agmobile.gzpssb.jhj.service.MyUploadWellService;
import com.augurit.agmobile.gzpssb.jhj.view.UploadWellDetailActivity;
...
public class MyWellAddListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View inflate = inflater.inflate(R.layout.fragment_my_add_well, null);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mSearchResultAdapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, long id) {
                ...
                Intent intent = new Intent(mContext, UploadWellDetailActivity.class);
    ...
    public void loadDatas(boolean ifShowPb) {
        ...
        final MyUploadWellService identificationService = new MyUploadWellService(mContext);
