...
public class UploadWellDetailActivity extends BaseActivity implements IDrawerController {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        UploadWellDetailMapFragment uploadDistributeMapFragment = UploadWellDetailMapFragment.getInstance(bundle);
