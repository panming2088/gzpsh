...
import com.augurit.agmobile.patrolcore.selectlocation.view.ISelectLocationPresenter;
import com.augurit.agmobile.patrolcore.selectlocation.view.ISelectLocationView;
import com.augurit.agmobile.patrolcore.selectlocation.view.SelectLocationPresenter;
import com.augurit.agmobile.patrolcore.selectlocation.view.SelectLocationVIew;
...
public class PshSelectLocationFragment extends Fragment {
    ...
    public static PshSelectLocationFragment newInstance(boolean ifReadOnly, LatLng location, double initScale, String destination) {

        PshSelectLocationFragment selectLocationFragment = new PshSelectLocationFragment();
