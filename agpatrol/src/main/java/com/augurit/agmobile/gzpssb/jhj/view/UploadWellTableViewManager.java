...
public class UploadWellTableViewManager {
    ...
    public UploadWellTableViewManager(
            Context context,
...
//            }
    ...
    private void addAttributeView() {
        ...
        if ("窨井".equals(uploadedFacility.getLayerName())) {
            ...
            YinjingAttributeViewUtilNew.addReadOnlyAttributes(mContext, yinjingAttributes, ll_attributelist_container, null, point, uploadedFacility);
    ...
    private void initView() {
        ...
        root = LayoutInflater.from(mContext).inflate(R.layout.view_upload_well_table_view, null);
