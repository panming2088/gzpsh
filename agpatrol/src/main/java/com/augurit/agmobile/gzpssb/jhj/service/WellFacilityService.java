...
import com.augurit.agmobile.gzpssb.jhj.dao.UploadWellApi2;
import com.augurit.agmobile.gzpssb.jhj.dao.WellFacilityApi;
...
public class WellFacilityService {
    ...
    private WellFacilityApi identificationApi;
    ...
    private UploadWellApi2 identificationApi2;
    private GzpsApi gzpsApi2;

    public WellFacilityService(Context mContext) {
    ...
    private void initAMNetwork(String serverUrl) {
        if (amNetwork == null) {
            ...
            this.amNetwork.registerApi(WellFacilityApi.class);
            this.amNetwork.registerApi(GzpsApi.class);
            this.identificationApi = (WellFacilityApi) this.amNetwork.getServiceApi(WellFacilityApi.class);
...
//        this.gzpsApi2 = (GzpsApi) this.amNetwork2.getServiceApi(GzpsApi.class);
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .baseUrl(serverUrl)
                .build();
        identificationApi2 = retrofit.create(UploadWellApi2.class);
    }
...
//                    uploadedFacility.getMarkTime(),
    ...
    public Observable<WellMonitorInfo> getUploadFacilityById1(long markId) {
        WellAffairService facilityAffairService = new WellAffairService(mContext);
