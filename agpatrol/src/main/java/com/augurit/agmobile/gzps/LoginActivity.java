...
import com.augurit.agmobile.gzpssb.okhttp.OKhttptUtils;
...
//        final String url = "http://" + LoginConstant.SERVER_URL + LoginConstant.LOGIN_URL + userName + "/" + password;
        final String url = PortSelectUtil.getAgWebPortBaseURL(this) + "rest/system/getUser/" + userName + "/" + password;
        ...
        mLoginService.loginGet(url, new Callback2<User>() {
            ...
            public void onSuccess(User user) {
                ...
                LoginRoleManager.setCurLoginRole(user.getRoleCode());
...
//                mActionNetLogic = new ActionNetLogic(LoginActivity.this, "http://" + LoginConstant.SERVER_URL + "/");
                mActionNetLogic = new ActionNetLogic(LoginActivity.this, PortSelectUtil.getAgWebPortBaseURL(LoginActivity.this));
                // 登录成功
...
//                String url = "http://" + LoginConstant.GZPSH_AGSUPPORT + "/rest/installPsh/saveInstallInf";
                String url = PortSelectUtil.getAgWebPortBaseURL(LoginActivity.this) + "rest/installPsh/saveInstallInf";
...
//                        .build();
                ...
                OKhttptUtils.getClient().newCall(request).enqueue(new Callback() {
                    @Override
...
//            String url = "http://" + LoginConstant.SERVER_URL + "/";
            String url = PortSelectUtil.getAgWebPortBaseURL(this);
    ...
    private void checkVersionUpdate() {
        checkVersionUpdateWithPermissonCheck(this, LoginConstant.APP_UPDATE_URL_ARR);
    }

    private void checkVersionUpdateWithPermissonCheck(Context context, String appUpdateUrlArr[]) {
...
//        String url = "http://" + LoginConstant.SERVER_URL + LoginConstant.CHECK_USERNAME_URL + userName;
        String url = PortSelectUtil.getAgWebPortBaseURL(this) + "rest/system/checkUserName/" + userName;
    ...
    private void init() {
        ...
        //动态修改Service
        LayerServiceFactory.injectLayerService(new AgwebPatrolLayerService(this.getApplicationContext()));
        ProjectServiceFactory.injectProjectService(new AgwebProjectService());
        PatrolSearchServiceProvider.injectSearchService(new PatrolSearchServiceImpl2(this.getApplicationContext()));
    }
