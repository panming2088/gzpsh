...
import com.augurit.agmobile.patrolcore.editmap.EditPointFragment;
...
public class BottomsheetEditMapFeatureActivity extends BaseActivity implements IDrawerController {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (EditModeConstant.EDIT_LINE.equals(editMode)) { //编辑线的界面
            BottomsheetEditLineFeatureFragment4 selectLocationFragment = BottomsheetEditLineFeatureFragment4
