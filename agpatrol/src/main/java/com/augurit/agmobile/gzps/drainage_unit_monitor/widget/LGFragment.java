...
public class LGFragment extends Fragment {
    ...
    private void initView() {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                service.addPsdyWtjc(user.getLoginName(), getAttrValue(map, "OBJECTID"), getAttrValue(map, "单元名称"), "2", "0")
    ...
    private void getPsdyWtjc() {
        service.getPsdyWtjc(component.getObjectId() + "", "2")
    ...
    private void setQuestion(String reporter, long time) {
        llItem.addView(createQuestionCheck("立管存在破损"));
        llItem.addView(createQuestionCheck("立管无标识/标识错误"));
        llItem.addView(createQuestionCheck("私接混接"));
    ...
    private void loadData() {
        ...
        service.getEventList(pageNo, pageSize, "lgjc", null, component.getObjectId() + "", keyword)
    ...
    private void addEventUpload(JbjMonitorArg args) {
        if (args == null) {
            args = new JbjMonitorArg();
        }
        Map<String, Object> map = component.getGraphic().getAttributes();
