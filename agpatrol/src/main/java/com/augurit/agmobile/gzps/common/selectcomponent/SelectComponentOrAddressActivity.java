...
public class SelectComponentOrAddressActivity extends BaseActivity implements IDrawerController {
...
//                .newInstance(geometry, initScale);
        ...
        SelectComponentOrAddressFragment2 selectLocationFragment = SelectComponentOrAddressFragment2.getInstance(bundle);
