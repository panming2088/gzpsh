...
public class BaiduSelectLocationPresenter implements IEditMapFeaturePresenter {

    protected ISelectLocationService mSelectLocationService;
    protected IEditMapFeatureView mSelectLocationView;

    public BaiduSelectLocationPresenter(ISelectLocationService selectLocationService, IEditMapFeatureView selectLocationView){
