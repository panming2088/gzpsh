...
public class PSHUploadFacilityMapActivity extends BaseActivity implements IDrawerController {
    protected ProgressLinearLayout progress_linearlayout;
    protected DrawerLayout drawer_layout;

    private PSHUploadFacilityMapFragment addComponentFragment;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        addComponentFragment = new PSHUploadFacilityMapFragment();
