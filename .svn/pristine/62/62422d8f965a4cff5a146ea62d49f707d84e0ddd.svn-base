...
public class SewerageTotalRoomClickFragment extends MyBaseFragment implements ISewerageRoomClickView {
    ...
    public static SewerageTotalRoomClickFragment newInstance() {
        SewerageTotalRoomClickFragment sewerageTotalFragment = new SewerageTotalRoomClickFragment();
