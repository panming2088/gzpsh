...
public class PSHFireDetailLayerService extends AgwebPatrolLayerService2{

    public PSHFireDetailLayerService(Context mContext) {
       super(mContext);
    }
                ...
                .map(new Func1<List<LayerInfo>, List<LayerInfo>>() {
                    ...
                    public List<LayerInfo> call(List<LayerInfo> layerInfos) {
                        ...
                        for (LayerInfo layerInfo : layerInfos){
                                if(layerInfo.getLayerName().equals(PatrolLayerPresenter.FIRE_LAYER)){
