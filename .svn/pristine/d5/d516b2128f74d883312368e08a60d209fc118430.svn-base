 ...
 * @modifyMemo 修改备注：
 */
public class AMBarChart extends AMBaseChart {

    private BarChart mBarChart;

    public AMBarChart(Context context) {
        super(context, null);
    }

    public AMBarChart(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
    }

    public AMBarChart(Context context, AttributeSet attrs, int defStyleAttr) {
