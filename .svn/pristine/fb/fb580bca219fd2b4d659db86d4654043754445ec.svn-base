...
public class DialyPatrolRecordListFragment extends Fragment {
    ...
    public void loadDatas(boolean ifShowPb) {
        ...
        identificationService.getPshDiaryLog(mUnitListBean.getId(),page, LoadDataConstant.LOAD_ITEM_PER_PAGE, mFacilityFilterCondition)
                //获取列表（不包含附件）
