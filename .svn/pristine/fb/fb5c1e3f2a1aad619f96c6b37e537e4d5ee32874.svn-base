...
import com.augurit.agmobile.patrolcore.selectlocation.view.SelectLocationFragment;
...
public class PshSelectLocationActivity extends AppCompatActivity implements IDrawerController {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PshSelectLocationFragment selectLocationFragment = PshSelectLocationFragment
