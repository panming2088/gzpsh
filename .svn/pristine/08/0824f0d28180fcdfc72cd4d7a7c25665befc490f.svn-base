...
/**
 * 控制我的上报门牌列表详情界面控制我的上报开关
 * Created by xcl on 2017/12/7.
 */

public class PSHUploadDoorNoDetailLayerService extends AgwebPatrolLayerService2{
    ...
    public PSHUploadDoorNoDetailLayerService(Context mContext) {
       super(mContext);
    }
                ...
                .map(new Func1<List<LayerInfo>, List<LayerInfo>>() {
                    ...
                    public List<LayerInfo> call(List<LayerInfo> layerInfos) {
                        ...
                        for (LayerInfo layerInfo : layerInfos){
                            if(layerInfo.getLayerName().equals(PatrolLayerPresenter.DOOR_NO_LAYER)){
