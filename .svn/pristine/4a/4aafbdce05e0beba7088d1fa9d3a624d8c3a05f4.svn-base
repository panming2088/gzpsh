package com.augurit.agmobile.gzpssb.uploadevent.view.eventedit;
 ...
 *
 */
public class PSHEventEditActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        dbService = new TableDBService(PSHEventEditActivity.this);
...
//                facilityName = preProblemUploadBean.getSSLX();
    ...
    private void initView() {
      ...
      //  initUrgencyView();
        ...
        progressDialog = new ProgressDialog(PSHEventEditActivity.this);
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                       ...
                       /* ||user.getRoleCode().contains(GzpsConstant.roleCodes[3])
                        || user.getRoleCode().contains(GzpsConstant.roleCodes[4]) */)){
                            //Rg和Rm暂时不能上报
                            ToastUtil.longToast(PSHEventEditActivity.this,
...
//                });
        ...
        findViewById(R.id.ll_select_component).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PSHEventEditActivity.this,
        ...
        findViewById(R.id.ll_back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogUtil.MessageBox(PSHEventEditActivity.this, "提示", "是否确定放弃本次编辑？", new DialogInterface.OnClickListener() {
                    @Override
                        ...
                        if(list != null &&
                          ...
                          orgItems= list;
                            ...
                            for (int i = 0; i < size; i++) {
                                RadioButton radioButton = new RadioButton(PSHEventEditActivity.this);
...
//            roadItem.setText("");
    ...
    private void sendToServer() {
        UploadEventService eventService = new UploadEventService(PSHEventEditActivity.this);
            ...
            eventService.editEvent(reportId, delImgs, json, assigneeCode, assigneeName,isSendMessage)
                    ...
                    .subscribe(new Subscriber<Boolean>() {
                        ...
                        public void onNext(Boolean s) {
                            if (!s) {
                                progressDialog.dismiss();
                                ToastUtil.shortToast(PSHEventEditActivity.this, "提交失败，请重试！");
                            } else {
                                progressDialog.dismiss();
                                ToastUtil.shortToast(PSHEventEditActivity.this, "提交成功");
...
//            }
        ...
        problemUploadBean.setSBR(BaseInfoManager.getUserName(PSHEventEditActivity.this));
