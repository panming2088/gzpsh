package com.augurit.agmobile.gzpssb.pshstatistics.model;
...
public class PSHUploadStatisticBean {
    ...
    public String getUnCheckStr(){
        return getString(total - passTotal - doubtTotal);
    }
