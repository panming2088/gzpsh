...
import com.augurit.agmobile.gzpssb.ItemSererageInvetCurrencyData;
...
public class SewerageInvesttigatedRoomClickFragment extends MyBaseFragment implements ISewerageRoomClickView {

    private SewerageRoomClickPersenter sewerageRoomClickPersenter = new SewerageRoomClickPersenter(this);
    private ItemSererageInvetCurrencyData itemSererageCurrencyData;
    ...
    public static SewerageInvesttigatedRoomClickFragment newInstance() {
        SewerageInvesttigatedRoomClickFragment sewerageTotalFragment = new SewerageInvesttigatedRoomClickFragment();
    ...
    @Override
    public int initview() {
        return R.layout.item_sewerage_currency_invest;
    ...
    public void getRoomClickdata(int page) {
        sewerageRoomClickPersenter.getdata(MyApplication.ID, page, 10, 1, 0);
    }
