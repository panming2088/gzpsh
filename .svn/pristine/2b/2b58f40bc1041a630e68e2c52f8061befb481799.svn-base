...
public interface ILayerDownloadService {
    ...
    /**
     * 根据矩形范围计算所有level的天地图瓦片
     *
     * @param tileInfo 天地图瓦片信息
     * @param envelope 矩形范围
     * @return 计算得到的瓦片集合
     */
    ArrayList<Tile> calculateTdt(AGWMTSLayerInfo tileInfo, Envelope envelope);
     ...
     * @param listener 下载监听
     */
    void downloadTdts(final String serviceUrl,
