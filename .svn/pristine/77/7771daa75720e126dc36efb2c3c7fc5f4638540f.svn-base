...
public class PSHHouseListFragment extends Fragment {

    private PSHHouseListAdapter mSearchResultAdapter;
    ...
    public static PSHHouseListFragment newInstance(Bundle bundle) {
        PSHHouseListFragment pshHouseListFragment = new PSHHouseListFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mSearchResultAdapter = new PSHHouseListAdapter(mContext, new ArrayList<PSHHouse>());
        rv_component_list.setAdapter(mSearchResultAdapter);
        mSearchResultAdapter.setOnRecycleitemOnClic(new PSHHouseListAdapter.OnClickHouseListener() {
            @Override
