...
import com.augurit.agmobile.gzpssb.pshstatistics.dao.PSHSignApi;
...
public class PSHSignService {


    public static final int LOAD_ITEM_PER_PAGE = 15;

    private AMNetwork amNetwork;
    private PSHSignApi signApi;
    private Context mContext;

    public PSHSignService(Context mContext) {
    ...
    private void initAMNetwork(String serverUrl) {
        if (amNetwork == null) {
            ...
            this.signApi = (PSHSignApi) this.amNetwork.getServiceApi(PSHSignApi.class);
        }
    }
