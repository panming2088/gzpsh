...
public class PSHUploadStatiscAdapter extends RecyclerView.Adapter<PSHUploadStatiscAdapter.MyViewHolder> {
    ...
    public PSHUploadStatiscAdapter(Context context) {
    ...
    @Override
    public PSHUploadStatiscAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        mInflater = LayoutInflater.from(context);
        View itemView = mInflater.inflate(R.layout.psh_upload_statisc_lt_item, parent,false);
