...
public class PSHUploadDoorNoDetailActivity extends BaseActivity implements IDrawerController {

    private DrawerLayout drawer_layout;
    private ViewGroup progress_linearlayout;
    private PSHUploadDoorNoDetailMapFragment uploadDistributeMapFragment;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        uploadDistributeMapFragment = PSHUploadDoorNoDetailMapFragment.getInstance(bundle);
