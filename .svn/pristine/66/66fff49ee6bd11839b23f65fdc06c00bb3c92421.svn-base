...
public class EJPSHUploadConditionView implements View.OnClickListener, Animation.AnimationListener {
...
//    private String[] allDistricts;
    ...
    public EJPSHUploadConditionView(View container, int curNwChiidPos, Context context) {
    ...
    public EJPSHUploadConditionView(View container, Context context) {
        this.mContainer = container;
        this.mContext = context;
        initView();
    }
...
//        }
        String[] componentTypeNameArr = new String[]{"工业类", "餐饮类", "建筑类", "医疗类", "农贸市场类", "畜禽养殖类", "机关事业单位类", "汽修机洗类", "洗涤类", "垃圾收集处理类", "综合商业类", "居民类", "其他"};
...
//                }
                ...
                EJPSHUploadFilterConditionEvent eventAffairConditionEvent = new EJPSHUploadFilterConditionEvent(
                        "全部".equals(componentType) ? null : componentType,
