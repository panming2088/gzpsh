...
public class PSHReEditUploadFacilityActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        facilityAttributeView = new FacilityAttributeView(PSHReEditUploadFacilityActivity.this, uploadedFacility);
        ...
        mComponentAddressErrorView = new FacilityAddressErrorView(PSHReEditUploadFacilityActivity.this,
                uploadedFacility);
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        ...
                        if (progressDialog == null) {
                            progressDialog = new ProgressDialog(PSHReEditUploadFacilityActivity.this);
                        ...
                        countDownTimer = new CountDownTimer(PSHUploadFacilityService.TIMEOUT * 1000, 1000) {
                            ...
                            public void onTick(long millisUntilFinished) {
                                ...
                                if (time % 20 == 0) {
                                    ToastUtil.longToast(PSHReEditUploadFacilityActivity.this, "网络忙，请稍等");
                                }
                            }
                        ...
                        identificationService.upload(uploadedFacility)
                                ...
                                .subscribe(new Subscriber<ResponseBody>() {
                                    ...
                                    public void onError(Throwable e) {
                                        ...
                                        ToastUtil.shortToast(PSHReEditUploadFacilityActivity.this, "提交失败");
                                    }
                                    ...
                                    public void onNext(ResponseBody responseBody) {
                                        ...
                                        if (responseBody.getCode() == 200) {
                                            ToastUtil.shortToast(PSHReEditUploadFacilityActivity.this, "提交成功");
                                            ...
                                            ToastUtil.shortToast(PSHReEditUploadFacilityActivity.this, "保存失败，原因是：" + responseBody.getMessage());
                                        }
                                    }
                                });
                    }
    ...
    protected void onDestroy() {
        ...
        if (!LocationUtil.ifUnRegister()) {
            LocationUtil.unregister(PSHReEditUploadFacilityActivity.this);
        }
