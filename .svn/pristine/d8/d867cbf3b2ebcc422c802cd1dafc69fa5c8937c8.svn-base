...
public class PSHHouseListActivity extends BaseActivity implements IDrawerController {
    protected ProgressLinearLayout progress_linearlayout;
    protected DrawerLayout drawer_layout;

    private PSHHouseListFragment mQueryAddressMapFragment;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mQueryAddressMapFragment = PSHHouseListFragment.newInstance(bundle);
