...
public class KGFragment extends Fragment {
    ...
    private void initView() {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                service.addPsdyWtjc(user.getLoginName(), getAttrValue(map, "OBJECTID"), getAttrValue(map, "单元名称"), "1", "0")
    ...
    private void getPsdyWtjc(){
        service.getPsdyWtjc(component.getObjectId() + "", "1")
    ...
    private void setQuestion(String reporter, long time){
        llItem.addView(createQuestionCheck("雨污混接"));
        llItem.addView(createQuestionCheck("结构性缺陷"));
        llItem.addView(createQuestionCheck("功能性缺陷"));
        llItem.addView(createQuestionCheck("私接管道"));
        llItem.addView(createQuestionCheck("防坠设施破损/缺失"));
    ...
    private void loadData() {
        ...
        service.getEventList(pageNo, pageSize, "kgjc", null, component.getObjectId() + "", keyword)
