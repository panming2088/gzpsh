...
//                Log.w(TAG, "Unable to find resource: " + mResource, e);
    ...
    /**
     * Set radii for each corner_color_primary.
     *
     * @param leftTop The desired radius for left-top corner_color_primary in dip.
     * @param rightTop The desired desired radius for right-top corner_color_primary in dip.
     * @param leftBottom The desired radius for left-bottom corner_color_primary in dip.
     * @param rightBottom The desired radius for right-bottom corner_color_primary in dip.
     *
     */
