...
public class PSHSeweragelayerPresenter extends PatrolLayerPresenter {
    ...
    protected List<LayerInfo> filterLayerNoNeedToAdd(List<LayerInfo> layerInfos) {
        ...
        while (iterator.hasNext()) {
            ...
            if (!mILayersService.ifActiveLayer(next) || next.getLayerName().contains("_新")
                    ...
                    ||DRAINAGE_DIALY.equals(next.getLayerName())|| DRAINAGE_DIALY2 .equals(next.getLayerName())
    ...
    public PSHSeweragelayerPresenter(ILayerView layerView, ILayersService layersService) {
