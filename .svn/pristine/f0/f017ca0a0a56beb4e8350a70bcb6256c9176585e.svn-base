 ...
 * @modifyMemo 修改备注：
 */
public class EventHouseListAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder, PSHHouse> {
    ...
    public EventHouseListAdapter(Context context, List<PSHHouse> mDataList) {
        super(mDataList);
    ...
    public BaseRecyclerViewHolder createViewHolder(LayoutInflater inflater, ViewGroup parent, int viewType) {
        return new ModifiedIdentificationViewHolder(inflater.inflate(R.layout.item_event_house_list, null));
    }
...
//            }else
            ...
            viewHolder.tv_left_up.setText(data.getName());
