...
public class PSHImageLegendDialog extends DialogFragment {
    ...
    public static PSHImageLegendDialog newInstance() {

        PSHImageLegendDialog legendDialog = new PSHImageLegendDialog();
        return legendDialog;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.legend_psh_image_dialog,container);
