...
public class PSHUploadDoorNoMapActivity extends BaseActivity implements IDrawerController {
    ...
    private PSHUploadDoorNoMapFragment addComponentFragment;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        addComponentFragment = new PSHUploadDoorNoMapFragment();
