...
import com.augurit.agmobile.gzpssb.fragment.QueryAddressMapFragment;
...
public class SewerageMapActivity extends BaseActivity implements IDrawerController {
    protected ProgressLinearLayout progress_linearlayout;
    protected DrawerLayout drawer_layout;

    private QueryAddressMapFragment mQueryAddressMapFragment;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mQueryAddressMapFragment = new QueryAddressMapFragment();
        mQueryAddressMapFragment.setArguments(getIntent().getExtras());
