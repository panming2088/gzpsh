...
import com.augurit.agmobile.gzpssb.uploadevent.adapter.PSHUploadEventPagerAdapter;
...
public class PshEventDetailActivity1 extends BaseActivity {

    private TextView all_count, install_count, no_install_count;
    private DrawerLayout drawer_layout;
    private PSHUploadEventPagerAdapter adapter;
    ...
    private void initView() {
        ...
        adapter = new PSHUploadEventPagerAdapter(getSupportFragmentManager(),
                this,bundle);
        ...
        PSHEventListItem mEventListItem = (PSHEventListItem) getIntent().getSerializableExtra("eventList");

        if((pshAffairDetail != null && pshAffairDetail.getData() == null)
                || TextUtils.isEmpty(mEventListItem.getSslx())
                || adapter.getCount() == 1){
