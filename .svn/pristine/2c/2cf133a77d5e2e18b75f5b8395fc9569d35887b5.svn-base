...
import com.augurit.agmobile.gzpssb.jhj.dao.MyUploadWellApi;
...
public class MyUploadWellService {
    ...
    private void initAMNetwork(String serverUrl) {
        if (amNetwork == null) {
            ...
            this.amNetwork.registerApi(MyUploadWellApi.class);
            this.amNetwork.registerApi(GzpsApi.class);
            this.identificationApi = (MyUploadWellApi) this.amNetwork.getServiceApi(MyUploadWellApi.class);
