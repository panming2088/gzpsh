...
public class PSHUploadNewFacilityActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        take_photo_item.getmExample().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PSHUploadNewFacilityActivity.this, PhotoExampleActivity.class);
                startActivity(intent);
            }
        });
        ((TextView) findViewById(R.id.tv_title)).setText("接驳井上报");
        ...
        facilityAttributeView = new PSHFacilityAttributeView(PSHUploadNewFacilityActivity.this);
        ...
        mComponentAddressErrorView = new FacilityAddressErrorView(PSHUploadNewFacilityActivity.this,
                temp);
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        ...
                        if (progressDialog == null) {
                            progressDialog = new ProgressDialog(PSHUploadNewFacilityActivity.this);
                        ...
                        countDownTimer = new CountDownTimer(PSHUploadFacilityService.TIMEOUT * 1000, 1000) {
                            ...
                            public void onTick(long millisUntilFinished) {
                                ...
                                if (time % 20 == 0) {
                                    ToastUtil.longToast(PSHUploadNewFacilityActivity.this, "网络忙，请稍等");
                                }
                            }
                                ...
                                .subscribe(new Subscriber<ResponseBody>() {
                                    ...
                                    public void onError(Throwable e) {
                                        ...
                                        CrashReport.postCatchedException(new Exception("新增上报失败，上报用户是：" +
                                                BaseInfoManager.getUserName(PSHUploadNewFacilityActivity.this) + "原因是：" + e.getLocalizedMessage()));
                                    }
                                    ...
                                    public void onNext(ResponseBody responseBody) {
                                        ...
                                        if (responseBody.getCode() == 200) {
                                            ...
                                            EventBus.getDefault().post(uploadFacility);
                                            finish();
                                        } else {
                                            showToast("保存失败，原因是：" + responseBody.getMessage());
                                            CrashReport.postCatchedException(new Exception("新增上报失败，上报用户是：" +
                                                    BaseInfoManager.getUserName(PSHUploadNewFacilityActivity.this) + "原因是：" + responseBody.getMessage()));
                                        }
                                    }
                                });
                    }
    ...
    protected void onDestroy() {
        ...
        if (!LocationUtil.ifUnRegister()) {
            LocationUtil.unregister(PSHUploadNewFacilityActivity.this);
        }
