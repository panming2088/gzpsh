...
public class SignYesterdayFragment extends Fragment {
    ...
    public static SignYesterdayFragment newInstance(Bundle bundle) {
        SignYesterdayFragment signTodayFragment = new SignYesterdayFragment();
        if (bundle != null) {
            signTodayFragment.setArguments(bundle);
        }
        return signTodayFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initView(view);
        initTime();
        curPos = getArguments().getInt("curPos", 1);
        return view;
    }
    ...
    private void getSignInfo() {
        ...
        if (curPos == 1) {
            ...
            pshSignStatisticService.getPSHSignInfo(org_name, year + "" + monthStr + "" + dayStr, curPos)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribe(new Subscriber<SignInfo>() {
                        @Override
            ...
            nwsignStatisticService.getNwSignInfo(org_name, year + "" + monthStr + "" + dayStr, curPos)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribe(new Subscriber<SignInfo>() {
                        @Override
