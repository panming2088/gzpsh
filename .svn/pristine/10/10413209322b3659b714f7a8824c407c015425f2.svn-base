...
public class TakePhotoTableItem2 extends LinearLayout {
    ...
    private int maxPhotoNum = 3;     //默认最多只能增加15张照片
    private RelativeLayout ll_tv_select_title_container;
    //    private ImageView iv_open_photo;


    public TakePhotoTableItem2(Context context) {
        this(context, null);
    }

    public TakePhotoTableItem2(Context context, AttributeSet attrs) {
        super(context, attrs);
