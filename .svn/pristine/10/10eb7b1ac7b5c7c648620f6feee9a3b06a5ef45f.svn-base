...
public class HangUpWellListFilterConditionView {
     ...
     * @param viewGroup
     */
    public HangUpWellListFilterConditionView(Context context, String filterTitle, String filterListType , ViewGroup viewGroup) {
    ...
    private View initView(String filterTitle) {
        final View root = View.inflate(mContext, R.layout.view_upload_history_filter_jhj, null);
