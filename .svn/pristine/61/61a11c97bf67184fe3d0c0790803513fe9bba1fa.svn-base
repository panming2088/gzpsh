...
public class PSHUploadListActivity extends BaseActivity {

    private TextView all_count, install_count, no_install_count;
    private DrawerLayout drawer_layout;
    private MyUploadStatiscPagerAdapter adapter;
    private PSHMyAddFacilityListFragment myAddFacilityListFragment;
    protected ProgressLinearLayout progress_linearlayout;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_psh_well_uploadlist);
        initView();
        EventBus.getDefault().register(this);
    }

    private void initView() {
        ((TextView) findViewById(R.id.tv_title)).setText("我的接驳井上报");
...
//                GravityCompat.END);
        ...
        myAddFacilityListFragment = new PSHMyAddFacilityListFragment();
