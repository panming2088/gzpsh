...
import com.augurit.agmobile.gzpssb.jhj.dao.WellCorrectFacilityApi;
import com.augurit.agmobile.gzpssb.jhj.dao.WellCorrectFacilityApi2;
...
public class WellCorrectFacilityService {

    public static final int TIMEOUT = 60;  //网络超时时间（秒）

    private AMNetwork amNetwork;
    private WellCorrectFacilityApi correctFacilityApi;
    ...
    private WellCorrectFacilityApi2 correctFacilityApi2;

    public WellCorrectFacilityService(Context mContext) {
    ...
    private void initAMNetwork(String serverUrl) {
        if (amNetwork == null) {
            ...
            this.amNetwork.registerApi(WellCorrectFacilityApi.class);
            this.correctFacilityApi = (WellCorrectFacilityApi) this.amNetwork.getServiceApi(WellCorrectFacilityApi.class);
        }
    }
...
//        this.correctFacilityApi2 = (CorrectFacilityApi2) this.amNetwork2.getServiceApi(CorrectFacilityApi2.class);
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .baseUrl(serverUrl)
                .build();
        correctFacilityApi2 = retrofit.create(WellCorrectFacilityApi2.class);
    }
