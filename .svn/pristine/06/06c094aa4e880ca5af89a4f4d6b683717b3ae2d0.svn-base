 ...
 */
public class AMToggleButton extends View {
    ...
    public AMToggleButton(Context context) {
        this(context, null);
    }

    public AMToggleButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AMToggleButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        checkerDrawable = getResources().getDrawable(R.mipmap.togglebutton_ic_true);
        XDrawable = getResources().getDrawable(R.mipmap.togglebutton_ic_close);
//        animateScroll();
    }
        ...
        if(isOpen){
            ...
            myScrollAnimation.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    AMToggleButton.this.isOpen = true;
...
//                    System.out.println("状态:" + true);
            ...
            myScrollAnimation.setAnimationListener(new Animation.AnimationListener() {
                ...
                @Override
                public void onAnimationEnd(Animation animation) {
                    AMToggleButton.this.isOpen = false;
                    if(onToggleChangedListener != null){
