...
import com.augurit.agmobile.gzpssb.uploadevent.view.eventdetail.PSHEventAffairDetailFragment;
...
public class PSHEventAffairPagerAdapter extends FragmentStatePagerAdapter {
    private String[] titles = new String[]{"问题详情", "排水户信息"};
    private List<Fragment> mFragments = new ArrayList<>();
    private Context context;

    public PSHEventAffairPagerAdapter(FragmentManager fm, Context context) {
        super(fm);
        this.context = context;
        mFragments.add(new PSHEventAffairDetailFragment());
        mFragments.add(new SewerageTableFragment());
    }

    public PSHEventAffairPagerAdapter(FragmentManager fm, Context context, Bundle bundle) {
        super(fm);
        this.context = context;
        mFragments.add(new PSHEventAffairDetailFragment());
