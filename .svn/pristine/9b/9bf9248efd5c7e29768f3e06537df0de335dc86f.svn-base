...
//    public static final double latitude = 23.14901648232401;
    //海珠
    public static final double longitude = 113.292;
    public static final double latitude = 23.094;
    ...
    public static final String UPLOAD_WELL_LAYER_NAME = "接驳井";
    ...
    public static final String TYPICAL_DOOR_NO_LAYER = "典型排水户";
    public static final String DRAINAGE_UNIT_LAYER = "排水单元";
    public static final String WELL_LAYER = "接驳井";
    public static final String FIRE_LAYER = "地上式消防栓";
    public static final String DRAINAGE_USER = "排水户";
    public static final String DRAINAGE_USER2 = "排水户(市排导入)";
    public static final String DRAINAGE_DIALY = "排水户巡检";
    public static final String DRAINAGE_DIALY2 = "排水户巡检(市排导入)";
    /**
     * 排水管网
     */
    public static final String GW_LAYER_NAME = "排水管道";
    public static final String DISPLAY_DOOR_NO_LAYER = "门牌展图";
    //接驳连线
    public static final String JIE_BO_LIANXIAN = "接驳连线";
    ...
    public static final String DRAINAGE_JIEHUJING = "接户井";
    ...
    public void changeLayerVisibility(final String partlayerName, final boolean visible){
        getLayerObservable()
                ...
                .subscribe(new Subscriber<List<LayerInfo>>() {
                    ...
                    public void onNext(List<LayerInfo> layerInfos) {
                        for (LayerInfo layerInfo : layerInfos) {
//                            if (layerInfo.getLayerName().contains(partlayerName) && layerInfo.isDefaultVisible() != visible) {
                            /**
                             * 接驳井过滤时，出现接驳井连线切换控制接驳井了
                             */
                            if (partlayerName.equals(layerInfo.getLayerName()) && layerInfo.isDefaultVisible() != visible) {
                            /**
