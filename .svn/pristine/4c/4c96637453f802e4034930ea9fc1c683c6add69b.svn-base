 ...
 * @createTime 创建时间 ：17/9/19
 * @modifyBy 修改人 ：xuciluan
 * @modifyTime 修改时间 ：17/9/19
 * @modifyMemo 修改备注：
 */

public class LocalTable2 extends RealmObject {
    ...
    private RealmList<LocalTableItem2> list;
    ...
    public List<LocalTableItem2> getList() {
        return list;
    }

    public void setList(RealmList<LocalTableItem2> list) {
        this.list = list;
    }
