package com.augurit.agmobile.gzpssb.uploadevent.view.eventdraft;
 ...
 * 问题上报本地草稿详情编辑
 */
public class PSHEventDraftDetailActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        dbService = new TableDBService(PSHEventDraftDetailActivity.this.getApplicationContext());
                    ...
                    public void onNext(List<OrgItem> list) {
                        if(list != null &&
                            ...
                            for (int i = 0; i < size; i++) {
                                RadioButton radioButton = new RadioButton(PSHEventDraftDetailActivity.this);
...
//            selEventType(getSpinnerValueByCode(problemUploadBean.getBHLX()));
    ...
    private void initView() {
        ...
        progressDialog = new ProgressDialog(PSHEventDraftDetailActivity.this);
    ...
    private void initListener() {
        ...
        findViewById(R.id.ll_select_component).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PSHEventDraftDetailActivity.this, SelectComponentOrAddressActivity.class);
        ...
        findViewById(R.id.ll_back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogUtil.MessageBox(PSHEventDraftDetailActivity.this, "提示", "是否确定放弃本次编辑？", new DialogInterface.OnClickListener() {
                    @Override
...
//            selFacilityType(layerName);
    ...
    private void sendToServer() {
        UploadEventService eventService = new UploadEventService(PSHEventDraftDetailActivity.this);
        ...
        eventService.uploadEvent(isSendMessage,json, assigneeCode, assigneeName, photoBody)
                ...
                .subscribe(new Subscriber<Boolean>() {
                    ...
                    public void onNext(Boolean s) {
                        if (!s) {
                            progressDialog.dismiss();
                            ToastUtil.shortToast(PSHEventDraftDetailActivity.this, "提交失败，请重试！");
                        } else {
                            progressDialog.dismiss();
                            ToastUtil.shortToast(PSHEventDraftDetailActivity.this, "提交成功");
...
//                && (mSelComponent != null || mSelDetailAddress != null)
        ...
        problemUploadBean.setSBR(BaseInfoManager.getUserName(PSHEventDraftDetailActivity.this));
