package com.augurit.am.cmpt.widget.searchview;
...
import com.augurit.am.cmpt.widget.searchview.suggestions.SearchSuggestion;
import com.augurit.am.cmpt.widget.searchview.suggestions.SearchSuggestionsAdapter;
import com.augurit.am.cmpt.widget.searchview.util.Util;
import com.augurit.am.cmpt.widget.searchview.util.adapter.GestureDetectorListenerAdapter;
import com.augurit.am.cmpt.widget.searchview.util.adapter.OnItemTouchListenerAdapter;
import com.augurit.am.cmpt.widget.searchview.util.adapter.TextWatcherAdapter;
import com.augurit.am.cmpt.widget.searchview.util.view.MenuView;
import com.augurit.am.cmpt.widget.searchview.util.view.SearchInputView;
 ...
 * @author 创建人 ：guokunhu
 * @version 1.0
 * @package 包名 ：com.augurit.am.cmpt.widget.searchview
...
public class FloatingSearchView extends FrameLayout {
                ...
                if (isSearchBarFocused()) {
                    ...
                    switch (mLeftActionMode) {
                        case LEFT_ACTION_MODE_SHOW_HAMBURGER:
                            if(mMenuOpen){
                                if(onLeftMenuStateChangeListener != null){
                                    onLeftMenuStateChangeListener.onClose();
                                }
                            }else {
                                if(onLeftMenuStateChangeListener != null){
                                    onLeftMenuStateChangeListener.onOpen();
                                }
                            }
    ...
    public interface onLeftMenuStateChangeListener{
        void onOpen();
        void onClose();
    }

    private onLeftMenuStateChangeListener onLeftMenuStateChangeListener;

    public void setOnLeftMenuStateChangeListener(onLeftMenuStateChangeListener listener){
        onLeftMenuStateChangeListener = listener;
    }
}
