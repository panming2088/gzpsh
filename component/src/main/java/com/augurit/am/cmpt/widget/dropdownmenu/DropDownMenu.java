package com.augurit.am.cmpt.widget.dropdownmenu;
...
public class DropDownMenu extends LinearLayout{
    ...
    private void init(Context mContext){
        ...
        View popWindows = LayoutInflater.from(mContext).inflate(R.layout.dropdown_popupwindow_menu, null);
        ...
        mMenuCount=2;
        mShowCount=5;
        mMenuTitleTextColor=getResources().getColor(R.color.dropdown_default_menu_text);
        mMenuPressedBackColor=getResources().getColor(R.color.dropdown_default_menu_press_back);
        mMenuPressedTitleTextColor=getResources().getColor(R.color.dropdown_default_menu_press_text);
        mMenuBackColor=getResources().getColor(R.color.dropdown_default_menu_back);
        mMenuListBackColor=getResources().getColor(R.color.dropdown_white);
        mMenuListSelectorRes=R.color.dropdown_white;
        mMenuTitleTextSize=18;
        mArrowMarginTitle=10;
        mShowCheck=true;
        mShowDivider=true;
        mCheckIcon=R.drawable.ic_make_red;
        mUpArrow=R.mipmap.common_ic_arrow_up_grey;
        mDownArrow=R.mipmap.common_ic_arrow_down_grey;
