...
/**
 * 具有滑动菜单的RecyclerView
 * 在{@link SwipeMenuListView}的基础上修改为RecyclerView
 * 在Adapter中更新数据不再有效，请使用本类的{@link #notifyDataSetChanged()}方法来更新数据
 * @author 创建人 ：xiejiexin
 * @version 1.0
 * @package 包名 ：com.baoyz.swipemenulistview
 * @createTime 创建时间 ：2016-11-27 13:08
 * @modifyBy 修改人 ：xiejiexin
 * @modifyTime 修改时间 ：2016-11-27 13:08
 */
...
//                mTouchPosition = pointToPosition((int) ev.getX(), (int) ev.getY()) - getHeaderViewsCount();   // xjx 目前不考虑有Header的情况
...
//                    getSelector().setState(new int[]{0});     // xjx 注释掉
