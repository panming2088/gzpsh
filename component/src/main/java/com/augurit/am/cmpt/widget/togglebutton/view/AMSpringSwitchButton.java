 ...
 */
public class AMSpringSwitchButton extends View implements ViewTreeObserver.OnGlobalLayoutListener {
    private static final int DEFAULT_TEXTSIZE_SP = 16;
    private static final int DEFAULT_TEXTPADDING = 10;
    private static final int DEFAULT_TEXTCHECKED_COLOR = 0xFFFFFFFF;
    private static final int DEFAULT_TEXTUNCHECKED_COLOR = 0xffa668e4;
    private static final int DEFAULT_BACKRECT_COLOR = 0xffa668e4;
...
//    private float rightTextWidth;
    ...
    public AMSpringSwitchButton(Context context) {
        this(context, null);
    }

    public AMSpringSwitchButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AMSpringSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
