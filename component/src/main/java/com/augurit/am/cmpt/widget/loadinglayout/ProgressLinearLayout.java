package com.augurit.am.cmpt.widget.loadinglayout;
...
/**
 * 通用的加载视图，详细使用方法请参考:https://github.com/vlonjatg/progress-activity
 *
 * @author 创建人 ：xuciluan
 * @version 1.0
 * @package 包名 ：com.augurit.am.cmpt.widget.loadinglayout
...
public class ProgressLinearLayout extends LinearLayout {
    ...
    public void showEmpty(String emptyTextTitle) {
        switchState(EMPTY, null, emptyTextTitle, "", null, null, Collections.<Integer>emptyList());
    }
     ...
     *
     * @param errorTextTitle  Title of the error view to show
     * @param errorReason     Content of the error view to show
     * @param errorButtonText Text on the error view button to show
     * @param onClickListener Listener of the error view button
     */
    public void showError(String errorTextTitle, String errorReason, String errorButtonText, OnClickListener onClickListener) {
        switchState(ERROR, null, errorTextTitle, errorReason, errorButtonText, onClickListener, Collections.<Integer>emptyList());
    }
